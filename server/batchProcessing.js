...
function process_orders(newOrders){
    for (const order of newOrders){
        updateInventoryItem1 = `UPDATE ITEM SET quantity=quantity-${order['item1Quantity']} WHERE id=1`
        updateInventoryItem2 = `UPDATE ITEM SET quantity=quantity-${order['item2Quantity']} WHERE id=2`
        updateInventoryItem3 = `UPDATE ITEM SET quantity=quantity-${order['item3Quantity']} WHERE id=3`
        updateInventoryItem4 = `UPDATE ITEM SET quantity=quantity-${order['item4Quantity']} WHERE id=4`
        updateInventoryItem5 = `UPDATE ITEM SET quantity=quantity-${order['item5Quantity']} WHERE id=5`
